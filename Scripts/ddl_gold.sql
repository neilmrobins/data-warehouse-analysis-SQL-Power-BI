...
SELECT
    ...
    pn.prd_wholesale_cost   AS wholesale_cost,
    ...
    iv.reorder_level,
    iv.supplier_id,          
    iv.warehouse_location,
    iv.last_stock_update
FROM silver.crm_prd_info pn
LEFT JOIN silver.erp_px_cat_g1v2 pc
    ON pn.cat_id = pc.id
LEFT JOIN silver.crm_inventory_451 iv
    ON pn.prd_key = iv.prd_key
...
LEFT JOIN gold.dim_suppliers su
