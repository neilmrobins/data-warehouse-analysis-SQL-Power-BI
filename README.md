...
- **Data Enrichment (Python)**  
  Expanded sales dataset from ~60K → ~640K rows with realistic patterns, variability, and controlled data quality issues        
  Remodelled the customer datasets to redefine the age range profile and create 200 new customers   
